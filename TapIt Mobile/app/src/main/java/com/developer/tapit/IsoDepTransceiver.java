...
public class IsoDepTransceiver implements Runnable {	//holds AID(which should be similar to Desktop app)
	...
	public IsoDepTransceiver(IsoDep isoDep, OnMessageReceived onMessageReceived) {		//receive message from NFC
		this.isoDep = isoDep;
